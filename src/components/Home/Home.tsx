...
export const Home: React.FC<HomeProps> = ({setActive, showPostNav, setShowPostNav}) => {
    ...
    return (
        <div className="px-4 py-5 my-3 text-center">
            ...
            <p className="lead mb-4">This demo make use of data from <a className="jp-logo" href="https://jsonplaceholder.typicode.com/">JSON Placeholder</a>. Click on the buttons in the table to either update a particular user's details or view a particular user's posts. Click on the Addresses link to view the number of users living in each address.</p>
